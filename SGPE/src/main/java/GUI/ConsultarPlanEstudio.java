...
public class ConsultarPlanEstudio extends javax.swing.JFrame {
  ...
  Conexion conexionPDF = new Conexion();
...
//         conexion.obtenerStringFechaVigencia(fechaVigenciaLoca);
    ...
    private void initComponents() {
        ...
        btnGenerarPDFYCorreo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnGenerarPDFYCorreoActionPerformed(evt);
            }
        });
  ...
  private void btnRealizarBusquedaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRealizarBusquedaActionPerformed
    ...
    private void btnGenerarPDFYCorreoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGenerarPDFYCorreoActionPerformed
        
        Document documento = new Document();
       
        try {
            String ruta = System.getProperty("user.home");
            PdfWriter.getInstance(documento, new FileOutputStream(ruta + "/Desktop/Reporte_Planes.pdf"));
            documento.open();
            
            PdfPTable tabla = new PdfPTable(5);
            tabla.addCell("Código del curso");
            tabla.addCell("Nombre del curso");
            tabla.addCell("Bloque");
            tabla.addCell("Horas de la clase");
    ...
    }//GEN-LAST:event_btnGenerarPDFYCorreoActionPerformed
